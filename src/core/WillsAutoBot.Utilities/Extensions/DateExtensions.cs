...
namespace WillsAutoBot.Utilities.Extensions
{
    public static class DateExtensions
    {
        ...
        public static DateTime RoundToHour(this DateTime dateTime) => new DateTime(dateTime.Year, dateTime.Month,
            dateTime.Day, dateTime.Hour, 0, 0, dateTime.Kind);
        ...
        public static DateTime ToMidOfDay(this DateTime dateTime) =>
            new DateTime(dateTime.Year, dateTime.Month, dateTime.Day, 12, 0, 0, dateTime.Kind);
